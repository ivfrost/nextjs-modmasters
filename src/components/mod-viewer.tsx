...
export default function ModViewer(props: ModViewerProps) {
  ...
  return (
    <div className="container mx-auto max-w-4xl">
      ...
      <nav className="flex items-center gap-x-1 text-sm text-muted-foreground pb-2">
        <Link
          href="/"
      ...
      {/* Mod Header */}
      <div className="flex justify-between items-start pb-2! pt-6!">
        <div className="flex flex-col flex-1 gap-x-1 gap-y-1">
        ...
        {canEdit && href && (
          <div className="ml-4 flex items-center gap-2 self-end">
